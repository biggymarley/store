...
const GlassNavigation = () => {
  ...
  return (
    <nav className="z-20 glass-nav fixed left-0 right-0 top-0  mx-auto max-w-6xl  overflow-hidden border-[1px] border-white/10 bg-gradient-to-br from-black/100 to-black/20  md:left-6 md:right-6 md:top-6 md:rounded-2xl">
      <StickyCountdown />
